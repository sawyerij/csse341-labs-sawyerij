...
#define print_log(fmt, ...)                                                    \
  printf(CLR_GREEN "[LOG:%s:%d] " CLR_RESET fmt, __func__, __LINE__,           \
         ##__VA_ARGS__)
#endif

#ifndef print_err
#define print_err(fmt, ...)                                                    \
  printf(CLR_RED "[ERROR:%s:%d] " CLR_RESET fmt, __func__, __LINE__,           \
         ##__VA_ARGS__)
#endif

#ifndef print_warn
#define print_warn(fmt, ...)                                                   \
  printf(CLR_YELLOW "[WARNING:%s:%d] " CLR_RESET fmt, __func__, __LINE__,      \
         ##__VA_ARGS__)
#endif
